  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="{{ url('employee-management') }}"><i class="fa fa-link"></i> <span>Employee</span></a></li>
        <li class="treeview">
        ...
        <li><a href="{{ route('user-management.index') }}"><i class="fa fa-link"></i> <span>Users</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
